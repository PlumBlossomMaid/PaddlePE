"""CREPE collator: waveform → normalized frames → model input."""
...
# Constants from CREPE inference
SAMPLE_RATE = 16000
WINDOW_SIZE = 1024
HOP_LENGTH = 160


class CREPECollator(BaseCollator):
    """Convert HDF5 samples to CREPE training batches.

    Pipeline:
      1. Resample to 16 kHz
      2. Frame waveform (1024 window, 160 hop)
      3. Mean-center and variance-scale each frame
      4. Return (frames, f0) for loss
    """
